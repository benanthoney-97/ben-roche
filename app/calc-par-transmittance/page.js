...
export default function VoicePage() {
  const agentId = process.env.NEXT_PUBLIC_ELEVENLABS_AGENT_ID || "agent_9001k4d3drjreqht2jvtdc8vwq84";
  const heroLogo = process.env.NEXT_PUBLIC_BRAND_LOGO_URL || "https://aigtrvecjglsbqqzqige.supabase.co/storage/v1/object/public/dialogue-images/session-images/ben_roche_arctic_ice_ocean.webp";
  ...
  const businessName = process.env.NEXT_PUBLIC_BRAND_NAME || "Calculations of Arctic Ice-Ocean Interface Photosynthetically Active Radiation (PAR) Transmittance Values";
